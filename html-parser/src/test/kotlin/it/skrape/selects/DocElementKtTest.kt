...
class DocElementKtTest {
    ...
    @Test
    fun `can find all elements within this element by selector and invoke them to lambda will return generic value`() {
    ...
    @Test
    fun `can find first element within this element by selector and invoke them to lambda will return generic value`() {
