...
public actual abstract class DomTreeElement : CssSelectable() {
     ...
     * @see #textNodes()
     */
    public actual val text: String by lazy { element.text().orEmpty() }
     ...
     * @see outerHtml
     */
    public actual val html: String by lazy { element.html().orEmpty() }
     ...
     * @see text
     */
    public actual val outerHtml: String by lazy { element.outerHtml().orEmpty() }
