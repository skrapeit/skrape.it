...
@Language("HTML")
public fun aValidHtml(bodyInclude: String): String = """
    <!DOCTYPE html>
    <html lang="en">
        <head>
            ${aValidTitle()}
...
@Language("HTML")
public val aValidMarkupWithLinks: String = """
    <div> 
        foo
...
@Language("HTML")
public val aValidMarkupWithPictures: String = """
    <div> 
        foo
...
public fun <T> aValidDocument(bodyInclude: String = "", init: Doc.() -> T): T = htmlDocument(aValidHtml(bodyInclude)).init()

public fun aValidDocument(bodyInclude: String = ""): Doc = htmlDocument(aValidHtml(bodyInclude))

public fun aSelfClosingTag(tag: String): String = "<$tag custom-attr='$tag-attr' />"

public fun aStandardTag(tag: String): String = """<$tag class="$tag-class">i'm a $tag</$tag>"""
